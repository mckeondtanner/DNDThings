...
while True:
    ...
    if d20 == "1":
        ...
        if stat1 == "1":
            ...
            print("Athletics: Roll", "("+ str(roll) + ")", "+ Strength Score", "(" + str(strength) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
            print()
            print("-" * 172)
        elif stat1 == "2":
            print("1: Acrobatics\n2: Hacking\n3: Sleight of Hand\n4: Stealth")
            ...
            if dexcheck == "1":
                ...
                total = int(roll) + dexterity
                print("Hacking: Roll", "("+ str(roll) + ")", "+ Dexterity Score", "(" + str(dexterity) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif dexcheck == "3":
                total = int(roll) + dexterity
                print("Sleight of Hand: Roll", "("+ str(roll) + ")", "+ Dexterity Score", "(" + str(dexterity) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif dexcheck == "4":
                total = int(roll) + dexterity
            ...
            if intcheck == "1":
                ...
                total = int(roll) + intelligence
                print("Engineering: Roll", "("+ str(roll) + ")", "+ Intelligence Score", "(" + str(intelligence) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif intcheck == "3":
                total = int(roll) + intelligence
            ...
            if wischeck == "1":
                ...
                total = int(roll) + wisdom
                print("Diplomacy: Roll", "("+ str(roll) + ")", "+ Wisdom Score", "(" + str(wisdom) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif wischeck == "3":
                total = int(roll) + wisdom
                ...
                total = int(roll) + wisdom
                print("Medicine: Roll", "("+ str(roll) + ")", "+ Wisdom Score", "(" + str(wisdom) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif wischeck == "5":
        ...
        if toolcheck == "1":
            ...
            if toolstat == "1":
                total = int(roll) + strength + proficiency
                print("Mason's Tools: Roll", "("+ str(roll) + ")", "+ Strength Score", "(" + str(strength) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif toolstat == "2":
                total = int(roll) + dexterity + proficiency
                print("Mason's Tools: Roll", "("+ str(roll) + ")", "+ Dexterity Score", "(" + str(dexterity) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif toolstat == "3":
                total = int(roll) + constitution + proficiency
                print("Mason's Tools: Roll", "("+ str(roll) + ")", "+ Constitution Score", "(" + str(constitution) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif toolstat == "4":
                total = int(roll) + intelligence + proficiency
                print("Mason's Tools: Roll", "("+ str(roll) + ")", "+ Intelligence Score", "(" + str(intelligence) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif toolstat == "5":
                total = int(roll) + wisdom + proficiency
                print("Mason's Tools: Roll", "("+ str(roll) + ")", "+ Wisdom Score", "(" + str(wisdom) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
            elif toolstat == "6":
                total = int(roll) + charisma + proficiency
                print("Mason's Tools: Roll", "("+ str(roll) + ")", "+ Charisma Score", "(" + str(charisma) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "=", str(total))
                print()
                print("-" * 172)
        elif toolcheck == "2":
            print("1: Strength\n2: Dexterity\n3: Constitution\4: Intelligence\n5: Wisdom\n6: Charisma")
        ...
        if attackroll == "1":
            ...
            if attackstat == "1":
                ...
                print("Or")
                total = int(roll) + strength + proficiency + gwm
                print("Strength Attack Roll: Roll", "("+ str(roll) + ")", "+ Strength Score", "(" + str(strength) + ")", "+ Proficiency", "(" + str(proficiency) + ")", "- Great Weapon Master", "(" + str(gwm) + ")", "=", str(total))
                print()
                print("-" * 172)
                print("1: Hit\n2: Miss")
